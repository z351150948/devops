...
.glass-card{background:linear-gradient(180deg,#fff 0%,#f8fbff 100%);border:1px solid rgba(148,163,184,.18);border-radius:18px;box-shadow:0 16px 34px rgba(15,23,42,.07);padding:14px 16px}.card-head{display:flex;align-items:center;justify-content:space-between;gap:12px;margin-bottom:14px;font-weight:600;color:#0f172a}.compact-head{margin-bottom:12px}
.composer-grid{display:grid;grid-template-columns:320px minmax(0,1fr);gap:16px}.library-grid{grid-template-columns:minmax(0,1.2fr) minmax(320px,.8fr)}.side-stack{display:flex;flex-direction:column;gap:14px}.task-form-head-actions,.history-actions{display:flex;align-items:center;gap:8px;flex-wrap:wrap}
