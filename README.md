...
AgDevOps ????? Django?Django REST framework?Channels?Vue 3 ? Element Plus ????????????? **CMDB?????????????????????Nginx ???????** ? **IaC ??** ??????
...
- **????**?AgDevOps ???????
- **????**??????????????????????
- **???**?Django / DRF / Channels / Vue 3 / Element Plus / Kubernetes Python Client / Terraform
- **????**?CMDB???????????????K8s / Docker ????????IaC ??
- **????**?????????? IaC ???????????? Docker / K8s ???????????????????? / ???????? CMDB ??????
...
- ?????????????????? `Docker ??`?`K8s ??`??????? / ????????????? CMDB ????
- K8s ???????????????????????????? Pod?PVC Pending ???????
- Pod ????????? Terminal??? WebSocket ???? shell?????? `ops.k8s.exec` ??
- ConfigMap / Secret ?? YAML ????? diff?????????????????
- Docker ?????????????????????????????????????
- SQL ??????? Tab ????? `MySQL`?`MongoDB`?`PolarDB`?????????????? RBAC ????
- ?????? `Docker Compose ??` ? `Kubernetes` ????????????????? K8s ????

## ???????????

- **????**??? CMDB???????????K8s?Docker???????IaC????? CRUD
- **????**????????????????? CMDB ???????
- **?????**????????????SSH ?????K8s API ??? CMDB ????
- **??????**?????????????????????
- **????**??????????????????
...
![CMDB ????](docs/screenshots/cmdb.png)
...
?????????????SQL / ????????????? `MySQL`?`MongoDB`?`PolarDB` ??????

### IaC ??

![IaC ??](docs/screenshots/iac-orchestration.png)
...
2. `CMDB ????`????????????????????????????
3. `????`?????????????????????????
4. `?????`????????SQL / ????????????? `MySQL`?`MongoDB`?`PolarDB`
5. `IaC ??`???????????? Terraform ?????????? CMDB
...
- `docs/screenshots/multicloud.png`
- `docs/screenshots/logs-or-sql.png`
