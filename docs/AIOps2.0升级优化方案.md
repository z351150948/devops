...
本文记录 Autotoll DevOps AIOps 2.0 的升级目标、架构调整点、核心能力清单与当前落地状态。它是平台智能体能力从“问答助手”走向“受控运维 Agent”的架构演进说明。
...
AIOps 2.0 的价值在于把 AI 做进 Autotoll DevOps 的运维控制面，而不是外接一个通用 Bot。当前系统已经围绕“Action 合同 + Skill 知识包 + 权限工具层 + 结构化 UI + 安全执行闭环”形成主要闭环，P0/P1/P2 的核心能力均已落地。
