...
DEMO_CREDENTIALS = [
    {'provider': 'aliyun', 'name': '阿里云-电商生产主账号', 'account_id': '100001', 'account_name': 'commerce-prod', 'auth_mode': 'demo', 'access_key_id': 'aliyun-demo-ak', 'access_key_secret': 'aliyun-demo-sk', 'default_region': 'cn-hangzhou', 'owner': 'SRE-张楠', 'description': '参考 AutoOps 的云账号 / 云主机纳管思路，提供电商生产账号 Demo。', 'tags': {'team': 'commerce'}, 'is_enabled': True, 'demo_mode': True},
...
DEMO_ENVIRONMENTS = [
    {'credential_name': '阿里云-电商生产主账号', 'name': '订单中心生产', 'code': 'commerce-prod-hz', 'business_line': '电商线', 'environment_type': 'prod', 'region': 'cn-hangzhou', 'zone': 'cn-hangzhou-h', 'vpc_name': 'vpc-commerce-prod', 'network_cidr': '10.10.0.0/16', 'owner': '电商 SRE', 'description': '订单、支付与网关核心生产环境。', 'tags': {'app': 'order-center', 'criticality': 'p0'}},
    {'credential_name': '阿里云-电商生产主账号', 'name': '数据平台共享', 'code': 'data-shared-hz', 'business_line': '数据平台', 'environment_type': 'shared', 'region': 'cn-shanghai', 'zone': 'cn-shanghai-a', 'vpc_name': 'vpc-data-shared', 'network_cidr': '10.40.0.0/16', 'owner': '数据平台', 'description': '共享 Kafka / Flink / Airflow 配套环境。', 'tags': {'app': 'data-platform', 'criticality': 'p1'}},
